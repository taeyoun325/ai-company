...
**DAY 25.** 전 구간이 돈다. 다만 **Mock 으로** 돈다 — 그리고 DAY 25 부터는
...
| 화면 (사무실·프로젝트·요금제·설정) | ✅ |
| 사무실 — 부서·회의실·대표실·비서실 | ✅ 직원 상태 5종 + 이유 한 줄 · 하루 시나리오 12단계 (DAY 25) |
| 대표 승인 지점 · 대표 지시창 | ✅ 승인·수정 요청·보류·폐기 · "왜 늦어져?" 는 병목 하나만 (DAY 25) |
| 태스크 병렬 실행 · 프로젝트별 권한 · 시간 지표 | ✅ (DAY 25) |
| 여러 Claude 세션 조정 | ✅ 다른 세션이 잡은 파일 편집을 훅이 막는다 (`scripts/claims.py`) |
